...
- A actual version of a 3D modeling software made for voxalBased games, it has the flexibility to create any shape within a square yet the placement of the models are purely designed for cordinate placements.
